...
from student_predictor.utils import save_object,evaluate_models
    ...
    def initiate_model_trainer(self,train_array,test_array):
        try:
            ...
            X_train,y_train,X_test,y_test=(
                train_array[:,:-1],  # This takes every column except the last one
                train_array[:,-1],  #this takes only the last column (this is your $y$ target/math score).
                test_array[:,:-1],
                test_array[:,-1]
            )
            models = {
